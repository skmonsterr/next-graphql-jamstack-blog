...
export type PostQuery = { __typename?: 'Query', post?: { __typename?: 'Post', title: string, content: { __typename?: 'RichText', markdown: string, html: string }, coverImage?: { __typename?: 'Asset', url: string } | null } | null };

export type PostsQueryVariables = Exact<{ [key: string]: never; }>;


export type PostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', title: string, slug: string, excerpt?: string | null, publishedAt?: any | null, coverImage?: { __typename?: 'Asset', url: string } | null, author?: { __typename?: 'Author', name: string, id: string, picture?: { __typename?: 'Asset', url: string } | null } | null }> };
...
export const PostsDocument = gql`
  ...
  posts(orderBy: updatedAt_DESC) {
    ...
    author {
      ...
      id
      picture {
        url(transformation: {image: {resize: {fit: crop, height: 40, width: 40}}})
      }
    }
  }
}
